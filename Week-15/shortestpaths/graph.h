...
namespace data {
    ...
    public:
        ...
        void add_edge(const std::string &from, const std::string &to, long int weight = 0);
        ...
        const edge& find_edge(const std::string &from, const std::string &to) const;
    ...
    public:
        ...
        long int weight() const;

    private:

        edge(graph &g, size_t source, size_t adjacent_vertex, long int weight = 0);
